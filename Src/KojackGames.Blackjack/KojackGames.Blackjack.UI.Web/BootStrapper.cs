    ...
    public class BootStrapper
    {
        ...
        public class DomainRegistry : Registry
        {
            public DomainRegistry()
            {
                ...
                For<IPlayingHandsEndGameStatusDecider>().Use<PlayingHandsEndGameStatusDecider>();
                For<IPlayDealersHand>().Use<PlayDealersHand>();
                For<IOptionsAvailableToPlayerAfterDealing>().Use<OptionsAvailableToPlayerAfterDealing>();
                For<IChipAllocator>().Use<ChipAllocator>();
