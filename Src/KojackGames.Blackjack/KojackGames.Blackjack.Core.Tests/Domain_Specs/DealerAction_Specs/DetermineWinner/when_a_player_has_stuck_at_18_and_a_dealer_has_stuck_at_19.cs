...
{
    [Subject(typeof(PlayingHandsEndGameStatusDecider))]
    public class when_a_player_has_stuck_at_18_and_a_dealer_has_stuck_at_19
    {
        private Establish context = () =>
        {
            ...
            SUT = new PlayingHandsEndGameStatusDecider(hand_scorer);
        };
            
        private Because of = () => SUT.decide_end_game_status_for_hands_in(playing_positions);
        ...
        private static PlayingHandsEndGameStatusDecider SUT;
